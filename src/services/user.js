...
// READ
export const getUserCurrent = (userId) => new Promise(async(resolve, reject) =>{
    try {
...
// update
export const updateUser = (userId, payload) => new Promise( async (resolve, reject) => {
    try {
...
// send otp
export const sendOtp = (id,email) => new Promise(async(resolve, reject) =>{
    try {
...
// verify otp
export const verifyOtp = (userId, otp) => new Promise(async(resolve, reject) => {
    try {
