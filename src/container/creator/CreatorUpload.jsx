            ...
            <div className={`creator-upload__edit row`}>
               <div className="upload-edit__info row">
                  ...
                  <div className="edit-detail__info row">
                     <span>
                        {infoEditDetail.slice(0, 20)}
                        {`${infoEditDetail.length >= 20 ? "..." : ""}`}
                     </span>
            ...
            {!showUploadDetail ? (
               ...
               <>
                  ...
                  <div className="upload-detail row">
                     <UploadPhone videoFile={videoFile}/>
                     <UploadDetail setInfoEditDetail={setInfoEditDetail} videoFile={videoFile} canvas={canvas} />
                  </div>
